...
/**
 * Clase principal, ejecuta mediante el método principal
 *
 * @author Janet Garcia
 */
public class POOP8 {
    ...
    public static void mainFiguras() {
        ...
        Triangulo triangulo2 = new Triangulo(30, 30, 30, 8, 8, 8, 8, 4.5f);
        ...
        Cuadrilatero cuadrilatero2 = new Cuadrilatero(45, 45, 8, 8, 8, 8, 8, 8);
...
*/
    ...
    /**
     * Método que, dada una instancia de Poligono 
     * Imprime a qué particularización pertenece: Triangulo o Cuadrilatero. El resultado lo imprime en pantalla.
     * 
